    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <img src="/layout/images/notfound/logo-blue.svg" alt="Sakai logo" className="mb-5 w-6rem flex-shrink-0" />
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <h1 className="text-900 font-bold text-5xl mb-2">Non trouvé</h1>
                        <div className="text-600 mb-5">La ressource demandée n'est pas disponible</div>
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">Questions fréquentes</span>
                        ...
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">Centre de solutions</span>
                        ...
                        <Link href="/" className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">Gestionnaire de permissions</span>
